...
namespace TK
{
    ...
    [CreateAssetMenu(fileName = "PCHSettingFile", menuName = "PCH/PCHSettingFile")]
    public class PCHPhysicsSetting : ScriptableObject, IEquatable<PCHPhysicsSetting>
    {
        ...
        {
            PCHChainProcessor.CreatePCHChainProcessor(go.transform, keyword, this);

        }

        #region Interface
        public bool Equals(PCHPhysicsSetting other)
        {
