...
{
    public static unsafe class PCHRunTimeJobsTable
    {
        #region Jobs
        [BurstCompile]
            ...
            public void Execute(int index)
            {
                ...
                switch (pReadCollider->colliderType)
                {
                    case ColliderType.Sphere:
                        ...
                        AABB = new MinMaxABBox(fromLocalPosition, toLocalPosition);
                    ...
                    case ColliderType.Capsule:
                        ...
                        temp1 = new MinMaxABBox(fromLocalPosition, fromLocalPosition + pReadCollider->fromDirection * pReadCollider->originHeight * colliderScale); 
                        temp2 = new MinMaxABBox(toLocalPosition, toLocalPosition + pReadCollider->toDirection * pReadCollider->originHeight * colliderScale); 
                        AABB = new MinMaxABBox(temp1, temp2);
                        AABB.Expand(pReadCollider->originRadius * colliderScale);
                    ...
                    case ColliderType.OBB:
                        ...
                        temp1 = MinMaxABBox.CreateFromCenterAndHalfExtents(fromLocalPosition, pReadCollider->originBoxSize * colliderScale); 
                        temp1 = MinMaxABBox.Rotate(pReadCollider->fromRotation, temp1);
                        temp2 = MinMaxABBox.CreateFromCenterAndHalfExtents(toLocalPosition, pReadCollider->originBoxSize * colliderScale);
                        temp2 = MinMaxABBox.Rotate(pReadCollider->toRotation, temp2);
                        AABB = new MinMaxABBox(temp1, temp2);
                        break;
                    default:
                        AABB = MinMaxABBox.identity;
                        break;
                }
            ...
            private void CollideProcess(PointRead* pReadPoint, PointReadWrite* pReadWritePoint, ColliderReadWrite* pReadWriteCollider, float pointRadius, float oneDivideIteration, bool isColliderInsideMode)
            {
                ...
                switch (pReadWriteCollider->colliderType)
                {
                    ...
                    case ColliderType.OBB: //OYM:OBB
                        ...
                        MinMaxABBox localOBB = MinMaxABBox.CreateFromCenterAndHalfExtents(0, size + pointRadius);
            ...
            public void Execute(int index)
            {
                ...
                if (isCollision && constraint->isCollider)
                {
                    for (int i = 0; i < colliderCount; ++i)
                    {
                        ...
                        MinMaxABBox constraintAABB = new MinMaxABBox(positionA, positionB);
