...
namespace TK
{
    ...
    public class PCHRuntimeConstraint
    {
        public ConstraintRead constraintRead;
        public PCHRuntimePoint pointA { get; private set; }
        public PCHRuntimePoint pointB { get; private set; }
        public Vector3 direction { get; private set; }

        public PCHRuntimeConstraint(ConstraintType type, PCHRuntimePoint pointA, PCHRuntimePoint pointB, float shrink, float stretch, bool isCollide)
        {
