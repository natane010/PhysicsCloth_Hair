...
namespace TK.Mono
{
    ...
    public class PCHColliderReader :MonoBehaviour, IPCHPhysicMonoComponent
    {
        public MonoBehaviour Target => this;
        public static Dictionary<int, PCHColliderReader> ColliderTokenDic
        {
            get
            {
                if (colliderTokenDic == null)
                {
                    colliderTokenDic = new Dictionary<int, PCHColliderReader>();
                    Application.quitting += () => colliderTokenDic = null;
                }
                return colliderTokenDic;
            }
        }
        private static Dictionary<int, PCHColliderReader> colliderTokenDic;
        ...
        public PCHRuntimeCollider runtimeCollider;
        ...
        bool CheckOrBuildSphereCollider()
        {
            ...
            runtimeCollider = new PCHSphereCollider(unitySphereCollider.radius, unitySphereCollider.center, colliderMask, unitySphereCollider.transform, collideFunc);
        ...
        bool CheckOrBuildCapsuleCollider()
        {
            ...
            runtimeCollider = new PCHCapsuleCollider(unityCapsuleCollider.radius, trueHeight, offset, direnction, colliderMask, unityCapsuleCollider.transform, collideFunc);
            runtimeCollider.InitialColliderData();
