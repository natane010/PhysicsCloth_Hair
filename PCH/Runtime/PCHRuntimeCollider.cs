...
namespace TK
{
    ...
    [Serializable]
    public abstract class PCHRuntimeCollider
    {
    ...
    public class PCHSphereCollider : PCHRuntimeCollider
    {
        public PCHSphereCollider(ColliderRead colliderRead, Transform appendtTransform)
        {
            this.colliderRead = colliderRead;
            this.appendTransform = appendtTransform;
        }
        public PCHSphereCollider(float radius, Vector3 positionOffset,ColliderChoice colliderChoice, Transform appendTransform = null, CollideFunc collideFunc = CollideFunc.OutsideLimit)
        {
    ...
    public class PCHCapsuleCollider : PCHRuntimeCollider
    {
        public PCHCapsuleCollider(ColliderRead colliderRead, Transform appendtTransform)
        {
            this.colliderRead = colliderRead;
            this.appendTransform = appendtTransform;
        }
        public PCHCapsuleCollider(float radius, Vector3 pointHead, Vector3 pointTail, ColliderChoice colliderChoice,Transform appendTransform ,CollideFunc collideFunc = CollideFunc.OutsideLimit)
        {
            colliderRead.isOpen = true;
        ...
        public PCHCapsuleCollider(float radius,float length, Vector3 positionOffset,Quaternion localRotation, ColliderChoice colliderChoice,Transform appendTransform , CollideFunc collideFunc = CollideFunc.OutsideLimit)
        {
            colliderRead.isOpen = true;
            colliderRead.colliderType = ColliderType.Capsule;
            colliderRead.collideFunc = collideFunc;
    ...
    public class OBBBoxCollider : PCHRuntimeCollider
    {
