...
namespace TK
{
    ...
    using Mono;
    using System.Linq;
    using static TK.Internal.PCHRunTimeJobsTable;

    public unsafe class PCHPhysicsKernel
    {
        static int BatchLength = 64;
        static int ScheduleBatchedLength = 32;
        private JobHandle Hjob;

        private PCHRunTimeJobsTable.ColliderClacAABB colliderCalcAABB;
        private PCHRunTimeJobsTable.ColliderPositionUpdate colliderUpdate;
        private PCHRunTimeJobsTable.PointGetTransform pointGet;
        private PCHRunTimeJobsTable.PointUpdate pointUpdate;
        private PCHRunTimeJobsTable.ConstraintUpdate constraintUpdates;
        private PCHRunTimeJobsTable.ConstraintForceUpdateByPoint constraintForceUpdateByPoint;
        private PCHRunTimeJobsTable.JobPointToTransform pointToTransform;
        ...
        public PCHPhysicsKernel()
        {
            ...
            collidersReadNativeArray = new NativeArray<ColliderRead>(PCHRuntimeController.MAXCOLLIDERCOUNT, Allocator.Persistent);
            collidersReadWriteNativeArray = new NativeArray<ColliderReadWrite>(PCHRuntimeController.MAXCOLLIDERCOUNT, Allocator.Persistent);
        }
        ...
        public void SetNativeArray()
        {
            ...
            colliderCalcAABB = new PCHRunTimeJobsTable.ColliderClacAABB();
            colliderUpdate = new PCHRunTimeJobsTable.ColliderPositionUpdate();

            pointGet = new PCHRunTimeJobsTable.PointGetTransform();
            pointUpdate = new PCHRunTimeJobsTable.PointUpdate();
            constraintUpdates = new PCHRunTimeJobsTable.ConstraintUpdate();
            constraintForceUpdateByPoint = new PCHRunTimeJobsTable.ConstraintForceUpdateByPoint();
            pointToTransform = new PCHRunTimeJobsTable.JobPointToTransform();
        ...
        public void restorePoint(float scale)
        {
            ...
            {
                PCHRunTimeJobsTable.InitiralizePoint1 initialpoint = new PCHRunTimeJobsTable.InitiralizePoint1
                {
                ...
                PCHRunTimeJobsTable.InitiralizePoint2 initialpoint2 = new PCHRunTimeJobsTable.InitiralizePoint2
                {
                    pReadPoints = (PointRead*)pointReadNativeArray.GetUnsafePtr(),
                    pReadWritePoints = (PointReadWrite*)pointReadWriteListNativeArray.GetUnsafePtr(),
                    worldScale = scale,
        ...
        internal void DrawGizmos()
        {
            ...
            {
                MinMaxABBox aabb = collidersReadNativeArray[i].AABB;
