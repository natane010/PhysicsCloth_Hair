...
namespace TK.Mono.Tool
{
    ...
    public class PCHColliderGenerateTool : MonoBehaviour
    {
        [SerializeField]
        ...
        [SerializeField]
        public List<PCHColliderReader> generateColliderList;
        [SerializeField]
        ...
        public void initializeCollider()
        {
            if (!isGenerateColliderAutomaitc)
            {
                ...
                generateColliderList.AddRange(gameObject.GetComponentsInChildren<PCHColliderReader>());
            }
            else
            {
                ...
                PCHChainProcessor[] chain = transform.GetComponentsInChildren<PCHChainProcessor>();
                List<PCHRuntimePoint> allNodeList;
                ...
                generateColliderList = PCHStaticColliderFunc.GenerateBodyCollidersData(transform, allNodeList, isGenerateFinger, isGenerateColliderOpenTrigger, out int isGenerateSuccessful);
