...
namespace TK.UntiyEditor
{
    ...
    [CustomEditor(typeof(PCHRuntimeController))]
    public class PCHRuntimeControllerEditor : Editor
    {
        private bool isFoldout;
        private bool[] isFoldouts;
        PCHRuntimeController controller;
        Dictionary<Object, Editor> containerEditors;
        private const int max=16;
        public void OnEnable()
        {

            controller = target as PCHRuntimeController;
