...
namespace TK.UntiyEditor
{
    ...
    public class PCHEditorColliderEditor : Editor
    {
        [CustomEditor(typeof(PCHColliderReader))]
        public class PCHRuntimeEditor : Editor
        {
            PCHColliderReader controller;
            ...
            {
                controller = (target as PCHColliderReader);
            }
            public override void OnInspectorGUI()
            {
                ...
                Titlebar("PCHコライダータグ", Color.Lerp(Color.white, Color.blue, 0.5f));
