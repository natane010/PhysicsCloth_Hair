...
namespace TK.UntiyEditor
{
    ...
    [CustomEditor(typeof(PCHChainGenerateTool))]

    public class PCHChainGeneratorEditor : Editor
    {
        PCHChainGenerateTool controller;
        ...
        {
            controller = target as PCHChainGenerateTool;
        }
        public override void OnInspectorGUI()
        {
            serializedObject.Update();

            Titlebar("PCHBoneGenerator", new Color(0.8F, 1, 1),0);
            ...
            switch ((ChainGeneratorModeCN)controller.generatorMode)
            {
                ...
                case ChainGeneratorModeCN.ClearMode:
                    if (GUILayout.Button("Clear all physics data", GUILayout.Height(22.0f)))
                    {
                        ...
                        {
                            PCHChainGenerateTool.ClearBoneChain(controller.transform);
